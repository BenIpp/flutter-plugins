...
class _CameraExampleHomeState extends State<CameraExampleHome> with WidgetsBindingObserver, TickerProviderStateMixin {
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((XFile? file) async {
      final xappDir = Directory('/storage/emulated/0/Download');
      final xfileName = path.basename(file!.path);
      final xsavedImage = await File(file!.path).copy('${xappDir.path}/$xfileName');
